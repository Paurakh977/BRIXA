...
import { Button } from "@BRIXA/ui/first_button"; 
import { Card } from "@BRIXA/ui/first_card";
import { 
            ...
            <div className="max-w-8xl mx-auto grid md:grid-cols-5 lg:grid-cols-6 gap-12 text-base">
              <div className="col-span-2">
                 ...
                 <p className="mt-6 text-brand-500 leading-relaxed text-sm max-w-sm">
                   The premium operating system for modern construction, bridging the gap between blueprint and reality with unwavering transparency.
                 </p>
